...
error: failed to push some refs to 'https://github.com/lakruzz/devx-tutorial-source'
@lakruzz ➜ /workspaces/devx-tutorial-source (main) $ mv  .git/hooks/pre-push .git/hooks/_pre-push
@lakruzz ➜ /workspaces/devx-tutorial-source (main) $ git push                                    
```
